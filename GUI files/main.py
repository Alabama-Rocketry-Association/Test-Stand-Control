...
if ser.isOpen() or ser.dummyMode() or ser.csvMode():
    if ser.isOpen():
        ...
        data_read = "CSV"
        press_csv = input("Name of the CSV file: ")
...
p_sensors1 = {
    'p_sensor1': Sensor('Pressure Sensor 1', 'Pressure', 1, 0, press_csv, data_read),
    # 'p_sensor2': Sensor('Pressure Sensor 2', 'Pressure', 1, 1, press_csv, data_read),
    # 'p_sensor3': Sensor('Pressure Sensor 3', 'Pressure', 1, 2, press_csv, data_read)
}
# Creating a second pressure sensor array
p_sensors2 = {
    'p_sensor4': Sensor('Pressure Sensor 4', 'Pressure', 2, 3, press_csv, data_read),
    #'p_sensor5': Sensor('Pressure Sensor 5', 'Pressure', 2, 4, press_csv, data_read),
    #'p_sensor6': Sensor('Pressure Sensor 6', 'Pressure', 2, 5, press_csv, data_read)
}
# Creating a third pressure sensor array
p_sensors3 = {
    'p_sensor7': Sensor('Pressure Sensor 7', 'Pressure', 3, 6, press_csv, data_read),
    #'p_sensor8': Sensor('Pressure Sensor 8', 'Pressure', 3, 7, press_csv, data_read),
    #'p_sensor9': Sensor('Pressure Sensor 9', 'Pressure', 3, 8, press_csv, data_read)
}
# Example temperature sensor objects and characteristics
'''
t_sensors = {
    't_sensor1': Sensor('Temperature Sensor 1', 'Temperature', 4, 0, press_csv, data_read),
    't_sensor2': Sensor('Temperature Sensor 2', 'Temperature', 4, 1, press_csv, data_read),
    't_sensor3': Sensor('Temperature Sensor 3', 'Temperature', 4, 2, press_csv, data_read)
}
'''
